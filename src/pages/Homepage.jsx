            ...
            <div className='w-[65%] h-min-[65vh] bg-white rounded-[10px] grid grid-cols-2 overflow-hidden'>
                <form onSubmit={handleSubmit} className='px-[8%] py-[10%]'>
                    ...
                    <div className='flex justify-center'>
                        {
                            isValidating === true ? <button type='submit' className='bg-[#666666] text-white px-[5%] py-[2%] rounded-[5px]'>SIGN UP</button>:<button type='submit' className='bg-[#cccccc] text-white px-[5%] py-[2%] rounded-[5px]' disabled>SIGN UP</button>
                        }
